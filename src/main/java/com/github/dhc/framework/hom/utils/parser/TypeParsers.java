package com.github.dhc.framework.hom.utils.parser;
...
public final class TypeParsers {
    ...
    private static final TypeParser ObjectParser = new TypeParser(){
    ...
    private static final TypeParser[] primaryParsers = new TypeParser[]{
